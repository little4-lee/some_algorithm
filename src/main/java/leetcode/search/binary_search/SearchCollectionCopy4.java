...
public class SearchCollectionCopy4 {
    /**
    ...
    private static class BinarySearch implements ISearch {
        ...
        public int search(int[] arr, int target) {
            ...
            while (lo <= hi) {
                ...
                if (arr[middle] > target) hi = middle - 1;
    ...
    public static void main(String[] args) {
        ...
        ISearch[] searchArray = {new BinarySearch(), new FindFirst(), new FindLast(), new FindFirstNotLessThan(), new FindLastNotMoreThan()};
