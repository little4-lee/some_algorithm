...
class L92Copy7 {
    ...
    public static void main(String[] args) {
        ...
        printList(new L92Copy7().reverseBetween(arrayToList(1), 1, 1));
        System.out.println();

        printList(new L92Copy7().reverseBetween(arrayToList(1, 2), 1, 1));
        System.out.println();
        printList(new L92Copy7().reverseBetween(arrayToList(1, 2), 2, 2));
        System.out.println();
        printList(new L92Copy7().reverseBetween(arrayToList(1, 2), 1, 2));


        System.out.println();
        printList(new L92Copy7().reverseBetween(arrayToList(1, 2, 3, 4, 5), 2, 4));
        System.out.println();
        printList(new L92Copy7().reverseBetween(arrayToList(1, 2, 3, 4, 5), 2, 2));
    }
}
